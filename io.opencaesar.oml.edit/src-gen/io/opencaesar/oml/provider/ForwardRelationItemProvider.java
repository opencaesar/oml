 ...
 * @generated
 */
public class ForwardRelationItemProvider extends RelationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ForwardRelationItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns ForwardRelation.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ForwardRelation"));
	}
	...
	public String getText(Object object) {
		String label = ((ForwardRelation)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ForwardRelation_type") :
			getString("_UI_ForwardRelation_type") + " " + label;
	}

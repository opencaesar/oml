...
public class ConceptInstanceItemProvider extends NamedInstanceItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OmlPackage.Literals.CONCEPT_INSTANCE__OWNED_TYPES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConceptInstance.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OmlPackage.Literals.CONCEPT_INSTANCE__OWNED_TYPES,

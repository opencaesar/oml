...
/**
 * This is the item provider adapter for a {@link io.opencaesar.oml.SpecializableTerm} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SpecializableTermItemProvider extends TermItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SpecializableTermItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((SpecializableTerm)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SpecializableTerm_type") :
			getString("_UI_SpecializableTerm_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SpecializableTerm.class)) {

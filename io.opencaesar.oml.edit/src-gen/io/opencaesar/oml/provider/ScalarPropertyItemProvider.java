...
public class ScalarPropertyItemProvider extends SemanticPropertyItemProvider {
	...
	protected void addFunctionalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScalarProperty_functional_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScalarProperty_functional_feature", "_UI_ScalarProperty_type"),
				 OmlPackage.Literals.SCALAR_PROPERTY__FUNCTIONAL,
				 true,
				 false,
				 false,
	...
	protected void addDomainsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScalarProperty_domains_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScalarProperty_domains_feature", "_UI_ScalarProperty_type"),
				 OmlPackage.Literals.SCALAR_PROPERTY__DOMAINS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addRangesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScalarProperty_ranges_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScalarProperty_ranges_feature", "_UI_ScalarProperty_type"),
				 OmlPackage.Literals.SCALAR_PROPERTY__RANGES,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ScalarProperty.class)) {

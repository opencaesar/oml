...
public class RelationEntityPredicateItemProvider extends UnaryPredicateItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RelationEntityPredicate_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RelationEntityPredicate_type_feature", "_UI_RelationEntityPredicate_type"),
				 OmlPackage.Literals.RELATION_ENTITY_PREDICATE__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OmlPackage.Literals.BINARY_PREDICATE__ARGUMENT1);
			childrenFeatures.add(OmlPackage.Literals.BINARY_PREDICATE__ARGUMENT2);
		}
	...
	public String getText(Object object) {
		return getString("_UI_RelationEntityPredicate_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OmlPackage.Literals.BINARY_PREDICATE__ARGUMENT1,
				 OmlFactory.eINSTANCE.createArgument()));

		newChildDescriptors.add
			(createChildParameter
				(OmlPackage.Literals.BINARY_PREDICATE__ARGUMENT2,
				 OmlFactory.eINSTANCE.createArgument()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == OmlPackage.Literals.UNARY_PREDICATE__ARGUMENT ||

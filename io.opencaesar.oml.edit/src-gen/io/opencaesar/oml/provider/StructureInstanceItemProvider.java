 ...
 * @generated
 */
public class StructureInstanceItemProvider extends InstanceItemProvider {
	/**
	...
	protected void addOwningAxiomPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StructureInstance_owningAxiom_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StructureInstance_owningAxiom_feature", "_UI_StructureInstance_type"),
				 OmlPackage.Literals.STRUCTURE_INSTANCE__OWNING_AXIOM,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addOwningAssertionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StructureInstance_owningAssertion_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StructureInstance_owningAssertion_feature", "_UI_StructureInstance_type"),
				 OmlPackage.Literals.STRUCTURE_INSTANCE__OWNING_ASSERTION,
				 true,
				 false,
				 true,
				 null,

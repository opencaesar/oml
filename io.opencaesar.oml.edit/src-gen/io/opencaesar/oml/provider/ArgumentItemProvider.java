...
/**
 * This is the item provider adapter for a {@link io.opencaesar.oml.Argument} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArgumentItemProvider extends ElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Argument_variable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Argument_variable_feature", "_UI_Argument_type"),
				 OmlPackage.Literals.ARGUMENT__VARIABLE,
				 true,
				 false,
				 false,
	...
	protected void addInstancePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Argument_instance_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Argument_instance_feature", "_UI_Argument_type"),
				 OmlPackage.Literals.ARGUMENT__INSTANCE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OmlPackage.Literals.ARGUMENT__LITERAL);
		}
	...
	public String getText(Object object) {
		String label = ((Argument)object).getVariable();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OmlPackage.Literals.ARGUMENT__LITERAL,

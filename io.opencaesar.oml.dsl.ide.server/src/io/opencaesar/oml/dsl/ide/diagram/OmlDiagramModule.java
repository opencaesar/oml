...
public class OmlDiagramModule extends DefaultDiagramModule {
	...
	// configureModelElement(context, 'label:relationship', SLabel,
	// RelationshipLabelView)
	public static String SLabel_RelationshipLabelView = "label:relationship";

	// configureModelElement(context, 'label:editable', OmlEditableLabel,
	// SLabelView)
	...
	// configureModelElement(context, 'comp:classHeader', SCompartment,

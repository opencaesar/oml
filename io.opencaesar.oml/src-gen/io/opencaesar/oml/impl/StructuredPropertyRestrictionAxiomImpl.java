...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Structured Property Restriction Axiom</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link io.opencaesar.oml.impl.StructuredPropertyRestrictionAxiomImpl#getProperty <em>Property</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class StructuredPropertyRestrictionAxiomImpl extends PropertyRestrictionAxiomImpl implements StructuredPropertyRestrictionAxiom {
	 ...
	 * @generated
	 */
	protected StructuredPropertyRestrictionAxiomImpl() {
		super();
	}
		...
		if (property != null && property.eIsProxy()) {
			...
			if (property != oldProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OmlPackage.STRUCTURED_PROPERTY_RESTRICTION_AXIOM__PROPERTY, oldProperty, property));
			}
		}
		return property;
	}
	...
	public void setProperty(StructuredProperty newProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmlPackage.STRUCTURED_PROPERTY_RESTRICTION_AXIOM__PROPERTY, oldProperty, property));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OmlPackage.STRUCTURED_PROPERTY_RESTRICTION_AXIOM__PROPERTY:

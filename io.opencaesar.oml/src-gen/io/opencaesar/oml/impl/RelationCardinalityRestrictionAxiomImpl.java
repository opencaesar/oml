...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Relation Cardinality Restriction Axiom</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link io.opencaesar.oml.impl.RelationCardinalityRestrictionAxiomImpl#getCardinality <em>Cardinality</em>}</li>
 *   <li>{@link io.opencaesar.oml.impl.RelationCardinalityRestrictionAxiomImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link io.opencaesar.oml.impl.RelationCardinalityRestrictionAxiomImpl#getRange <em>Range</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelationCardinalityRestrictionAxiomImpl extends RelationRestrictionAxiomImpl implements RelationCardinalityRestrictionAxiom {
	 ...
	 * @generated
	 */
	protected RelationCardinalityRestrictionAxiomImpl() {
		super();
	}
	...
	public void setCardinality(long newCardinality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmlPackage.RELATION_CARDINALITY_RESTRICTION_AXIOM__CARDINALITY, oldCardinality, cardinality));
	}
	...
	public void setKind(CardinalityRestrictionKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmlPackage.RELATION_CARDINALITY_RESTRICTION_AXIOM__KIND, oldKind, kind));
	}
	...
	public Entity getRange() {
		if (range != null && range.eIsProxy()) {
			...
			if (range != oldRange) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OmlPackage.RELATION_CARDINALITY_RESTRICTION_AXIOM__RANGE, oldRange, range));
			}
		}
		return range;
	}
	...
	public void setRange(Entity newRange) {
		...
		range = newRange;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmlPackage.RELATION_CARDINALITY_RESTRICTION_AXIOM__RANGE, oldRange, range));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OmlPackage.RELATION_CARDINALITY_RESTRICTION_AXIOM__KIND:
				return getKind();
			case OmlPackage.RELATION_CARDINALITY_RESTRICTION_AXIOM__RANGE:

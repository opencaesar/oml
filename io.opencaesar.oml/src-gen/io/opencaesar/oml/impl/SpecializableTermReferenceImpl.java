...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Specializable Term Reference</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link io.opencaesar.oml.impl.SpecializableTermReferenceImpl#getOwningVocabulary <em>Owning Vocabulary</em>}</li>
 *   <li>{@link io.opencaesar.oml.impl.SpecializableTermReferenceImpl#getOwnedSpecializations <em>Owned Specializations</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class SpecializableTermReferenceImpl extends ReferenceImpl implements SpecializableTermReference {
	/**
	 ...
	 * @generated
	 */
	protected SpecializableTermReferenceImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return OmlPackage.Literals.SPECIALIZABLE_TERM_REFERENCE;
	}
	...
	public Vocabulary getOwningVocabulary() {
		if (eContainerFeatureID() != OmlPackage.SPECIALIZABLE_TERM_REFERENCE__OWNING_VOCABULARY) return null;
	...
	public NotificationChain basicSetOwningVocabulary(Vocabulary newOwningVocabulary, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newOwningVocabulary, OmlPackage.SPECIALIZABLE_TERM_REFERENCE__OWNING_VOCABULARY, msgs);
		return msgs;
	}
	...
	public void setOwningVocabulary(Vocabulary newOwningVocabulary) {
		if (newOwningVocabulary != eInternalContainer() || (eContainerFeatureID() != OmlPackage.SPECIALIZABLE_TERM_REFERENCE__OWNING_VOCABULARY && newOwningVocabulary != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, OmlPackage.SPECIALIZABLE_TERM_REFERENCE__OWNING_VOCABULARY, newOwningVocabulary, newOwningVocabulary));
	}
	...
	public EList<SpecializationAxiom> getOwnedSpecializations() {
		if (ownedSpecializations == null) {
			ownedSpecializations = new EObjectContainmentWithInverseEList<SpecializationAxiom>(SpecializationAxiom.class, this, OmlPackage.SPECIALIZABLE_TERM_REFERENCE__OWNED_SPECIALIZATIONS, OmlPackage.SPECIALIZATION_AXIOM__OWNING_REFERENCE);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OmlPackage.SPECIALIZABLE_TERM_REFERENCE__OWNING_VOCABULARY:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetOwningVocabulary((Vocabulary)otherEnd, msgs);
			case OmlPackage.SPECIALIZABLE_TERM_REFERENCE__OWNED_SPECIALIZATIONS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == VocabularyStatement.class) {
			switch (derivedFeatureID) {
				case OmlPackage.SPECIALIZABLE_TERM_REFERENCE__OWNING_VOCABULARY: return OmlPackage.VOCABULARY_STATEMENT__OWNING_VOCABULARY;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == VocabularyStatement.class) {
			switch (baseFeatureID) {
				case OmlPackage.VOCABULARY_STATEMENT__OWNING_VOCABULARY: return OmlPackage.SPECIALIZABLE_TERM_REFERENCE__OWNING_VOCABULARY;
				default: return -1;
			}
		}

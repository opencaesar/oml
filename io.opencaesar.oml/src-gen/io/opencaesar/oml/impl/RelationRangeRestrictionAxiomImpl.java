...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Relation Range Restriction Axiom</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link io.opencaesar.oml.impl.RelationRangeRestrictionAxiomImpl#getRange <em>Range</em>}</li>
 *   <li>{@link io.opencaesar.oml.impl.RelationRangeRestrictionAxiomImpl#getKind <em>Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelationRangeRestrictionAxiomImpl extends RelationRestrictionAxiomImpl implements RelationRangeRestrictionAxiom {
	 ...
	 * @generated
	 */
	protected RelationRangeRestrictionAxiomImpl() {
		super();
	}
		...
		if (range != null && range.eIsProxy()) {
			...
			if (range != oldRange) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OmlPackage.RELATION_RANGE_RESTRICTION_AXIOM__RANGE, oldRange, range));
			}
		}
		return range;
	}
	...
	public void setRange(Entity newRange) {
		...
		range = newRange;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmlPackage.RELATION_RANGE_RESTRICTION_AXIOM__RANGE, oldRange, range));
	}
	...
	public void setKind(RangeRestrictionKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmlPackage.RELATION_RANGE_RESTRICTION_AXIOM__KIND, oldKind, kind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OmlPackage.RELATION_RANGE_RESTRICTION_AXIOM__RANGE:

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Enumeration Axiom</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link io.opencaesar.oml.impl.EnumerationAxiomImpl#getInstances <em>Instances</em>}</li>
 *   <li>{@link io.opencaesar.oml.impl.EnumerationAxiomImpl#getOwningConcept <em>Owning Concept</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumerationAxiomImpl extends AxiomImpl implements EnumerationAxiom {
	/**
	 ...
	 * @generated
	 */
	protected EnumerationAxiomImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return OmlPackage.Literals.ENUMERATION_AXIOM;
	}
	...
	public EList<ConceptInstance> getInstances() {
		if (instances == null) {
			instances = new EObjectResolvingEList<ConceptInstance>(ConceptInstance.class, this, OmlPackage.ENUMERATION_AXIOM__INSTANCES);
		}
		return instances;
	}
	...
	public Concept getOwningConcept() {
		if (eContainerFeatureID() != OmlPackage.ENUMERATION_AXIOM__OWNING_CONCEPT) return null;
	...
	public NotificationChain basicSetOwningConcept(Concept newOwningConcept, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newOwningConcept, OmlPackage.ENUMERATION_AXIOM__OWNING_CONCEPT, msgs);
		return msgs;
	}
	...
	public void setOwningConcept(Concept newOwningConcept) {
		if (newOwningConcept != eInternalContainer() || (eContainerFeatureID() != OmlPackage.ENUMERATION_AXIOM__OWNING_CONCEPT && newOwningConcept != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, OmlPackage.ENUMERATION_AXIOM__OWNING_CONCEPT, newOwningConcept, newOwningConcept));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OmlPackage.ENUMERATION_AXIOM__INSTANCES:
				return getInstances();
			case OmlPackage.ENUMERATION_AXIOM__OWNING_CONCEPT:

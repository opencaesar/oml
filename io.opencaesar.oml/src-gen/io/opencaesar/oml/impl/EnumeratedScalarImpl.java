...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Enumerated Scalar</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class EnumeratedScalarImpl extends ScalarImpl implements EnumeratedScalar {
	 ...
	 * @generated
	 */
	protected EnumeratedScalarImpl() {
		super();
	}
	...
	public EList<Literal> getLiterals() {
		if (literals == null) {
			literals = new EObjectContainmentEList<Literal>(Literal.class, this, OmlPackage.ENUMERATED_SCALAR__LITERALS);
		}
		return literals;
	}

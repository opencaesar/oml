...
public class OmlParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OmlGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSWRLPredicateAccess().getAlternatives(), "rule__SWRLPredicate__Alternatives");
			builder.put(grammarAccess.getRelationPredicateAccess().getAlternatives_4(), "rule__RelationPredicate__Alternatives_4");
			...
			builder.put(grammarAccess.getRelationEntityPredicateKindAccess().getAlternatives(), "rule__RelationEntityPredicateKind__Alternatives");
			...
			builder.put(grammarAccess.getVocabularyAccess().getGroup_3(), "rule__Vocabulary__Group_3__0");
			builder.put(grammarAccess.getBundleAccess().getGroup(), "rule__Bundle__Group__0");
			builder.put(grammarAccess.getBundleAccess().getGroup_3(), "rule__Bundle__Group_3__0");
			...
			builder.put(grammarAccess.getSWRLSameAsPredicateAccess().getGroup(), "rule__SWRLSameAsPredicate__Group__0");
			builder.put(grammarAccess.getSWRLDifferentFromPredicateAccess().getGroup(), "rule__SWRLDifferentFromPredicate__Group__0");
			...
			builder.put(grammarAccess.getVocabularyAccess().getSeparatorAssignment_3_1(), "rule__Vocabulary__SeparatorAssignment_3_1");
			builder.put(grammarAccess.getVocabularyAccess().getPrefixAssignment_5(), "rule__Vocabulary__PrefixAssignment_5");
			builder.put(grammarAccess.getVocabularyAccess().getOwnedImportsAssignment_7(), "rule__Vocabulary__OwnedImportsAssignment_7");
			builder.put(grammarAccess.getVocabularyAccess().getOwnedStatementsAssignment_8(), "rule__Vocabulary__OwnedStatementsAssignment_8");
			...
			builder.put(grammarAccess.getBundleAccess().getSeparatorAssignment_3_1(), "rule__Bundle__SeparatorAssignment_3_1");
			builder.put(grammarAccess.getBundleAccess().getPrefixAssignment_5(), "rule__Bundle__PrefixAssignment_5");
			builder.put(grammarAccess.getBundleAccess().getOwnedImportsAssignment_7(), "rule__Bundle__OwnedImportsAssignment_7");
			...
			builder.put(grammarAccess.getDescriptionAccess().getSeparatorAssignment_3_1(), "rule__Description__SeparatorAssignment_3_1");
			builder.put(grammarAccess.getDescriptionAccess().getPrefixAssignment_5(), "rule__Description__PrefixAssignment_5");
			builder.put(grammarAccess.getDescriptionAccess().getOwnedImportsAssignment_7(), "rule__Description__OwnedImportsAssignment_7");
			builder.put(grammarAccess.getDescriptionAccess().getOwnedStatementsAssignment_8(), "rule__Description__OwnedStatementsAssignment_8");
			...
			builder.put(grammarAccess.getAspectAccess().getOwnedKeyAssignment_4_1(), "rule__Aspect__OwnedKeyAssignment_4_1");
			...
			builder.put(grammarAccess.getConceptAccess().getOwnedKeyAssignment_4_1(), "rule__Concept__OwnedKeyAssignment_4_1");
			...
			builder.put(grammarAccess.getRelationEntityAccess().getOwnedKeyAssignment_5_8(), "rule__RelationEntity__OwnedKeyAssignment_5_8");
			...
			builder.put(grammarAccess.getAspectReferenceAccess().getOwnedKeyAssignment_5_1(), "rule__AspectReference__OwnedKeyAssignment_5_1");
			...
			builder.put(grammarAccess.getConceptReferenceAccess().getOwnedKeyAssignment_5_1(), "rule__ConceptReference__OwnedKeyAssignment_5_1");
			...
			builder.put(grammarAccess.getRelationEntityReferenceAccess().getOwnedKeyAssignment_6_1(), "rule__RelationEntityReference__OwnedKeyAssignment_6_1");
			...
			builder.put(grammarAccess.getRelationEntityPredicateAccess().getKindAssignment_4(), "rule__RelationEntityPredicate__KindAssignment_4");
			builder.put(grammarAccess.getRelationEntityPredicateAccess().getVariable2Assignment_5(), "rule__RelationEntityPredicate__Variable2Assignment_5");
			builder.put(grammarAccess.getSWRLSameAsPredicateAccess().getOwnedAnnotationsAssignment_0(), "rule__SWRLSameAsPredicate__OwnedAnnotationsAssignment_0");
			builder.put(grammarAccess.getSWRLSameAsPredicateAccess().getVariable1Assignment_1(), "rule__SWRLSameAsPredicate__Variable1Assignment_1");
			builder.put(grammarAccess.getSWRLSameAsPredicateAccess().getVariable2Assignment_3(), "rule__SWRLSameAsPredicate__Variable2Assignment_3");
			builder.put(grammarAccess.getSWRLDifferentFromPredicateAccess().getOwnedAnnotationsAssignment_0(), "rule__SWRLDifferentFromPredicate__OwnedAnnotationsAssignment_0");
			builder.put(grammarAccess.getSWRLDifferentFromPredicateAccess().getVariable1Assignment_1(), "rule__SWRLDifferentFromPredicate__Variable1Assignment_1");
			builder.put(grammarAccess.getSWRLDifferentFromPredicateAccess().getVariable2Assignment_3(), "rule__SWRLDifferentFromPredicate__Variable2Assignment_3");
			...
			builder.put(grammarAccess.getRelationPredicateAccess().getInverseAssignment_4_0(), "rule__RelationPredicate__InverseAssignment_4_0");

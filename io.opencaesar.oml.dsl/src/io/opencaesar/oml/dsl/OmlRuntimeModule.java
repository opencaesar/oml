...
public class OmlRuntimeModule extends AbstractOmlRuntimeModule {
	...
	public void configure(final Binder binder) {
		binder.bind(IPreferenceValuesProvider.class)
				.annotatedWith(FormatterPreferences.class).to(FormatterPreferenceValuesProvider.class);
		binder.bind(String.class).annotatedWith(Names.named(ImportUriResolver.IMPORT_URI_FEATURE))
				.toInstance("uri");
